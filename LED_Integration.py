...
while True:
    try:
        ...
        # Create the current coordinate
        current_coordinate = (row, col)

        # Check if the current coordinate matches the previous one
        ...
        # Print the coordinate only if it's been the same for three iterations
