...
// This needs to be: extern lv_obj_t * ui_Text;
...
void I2CTask(void *pvParameters) {
  for (;;) {
    readProxyData();                 // Function that handles I2C communication
    vTaskDelay(pdMS_TO_TICKS(100));  // Task delay, you can adjust the delay as needed
  }
}
...
void setup() {
    ...
    // Create I2C communication task
    xTaskCreate(I2CTask, "I2C Task", 2048, NULL, 1, NULL);
}
