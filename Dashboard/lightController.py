...
class LightController:
    ...
    def _send_messages(self):
        while True:
            ...
            time.sleep(5)  # Minimum delay of 5 seconds between messages
...
# Example usage
light_controller = LightController("/dev/ttyUSB0", 9600)
light_controller.send_coordinates(10, 20)
light_controller.send_path(30, 40, 50, 60)
